    ...
    if call.data == 'menu_vip':
        try:
            pay_text = (
                ...
                "🌐 **[เว็บ]** 📊 ดูกราฟสัดส่วนพอร์ต (Allocation) และผลตอบแทนย้อนหลัง\n"
                ...
                "🤖 **[บอท]** 🔔 **Custom Alerts:** ตั้งเตือนราคาส่วนตัว ถึงเป้าปุ๊บเด้งแจ้งปั๊บ\n"
                ...
                "🌐 **[เว็บ]** 🔄 **Web-to-Bot Sync:** ตั้งเตือนในเว็บ ซิงค์มาเตือนในบอทอัตโนมัติ\n"
            )
