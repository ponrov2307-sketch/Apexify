...
step "🧪 [8/11] Running Python warp-syntax check" \
     "\"\$PYTHON_BIN\" -m py_compile main.py config.py dashboard_login.py keep_alive.py admin_service.py alert_system.py database.py ai_analyzer.py technical_tools.py slipok_service.py news_context.py" "false"
