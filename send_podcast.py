...
def generate_script(market_info):
    ...
    จงเขียนสคริปต์พอดแคสต์ภาษาไทยที่ฟังลื่นแบบรายการจริง ความยาวประมาณ 2.5 ถึง 4 นาที
    เป้าหมายคือให้คนฟังรู้ทั้ง "เกิดอะไรขึ้น" และ "มันสำคัญยังไงกับตลาดวันนี้"

    โครงเรื่องที่ต้องมีครบแบบเนียนๆ โดยไม่ต้องใส่หัวข้อ:
    1. เปิดรายการทักทายยามเช้าแบบเป็นกันเอง
    2. เล่าภาพรวมตลาดเมื่อคืนให้ละเอียดกว่าการบอกตัวเลขเฉยๆ
    3. อธิบายความหมายของตัวเลขเหล่านั้นต่ออารมณ์ตลาด เงินทุน และสินทรัพย์เสี่ยง
    4. เชื่อมโยงให้เห็นว่าบรรยากาศแบบนี้อาจมีผลกับการเทรดหรือการลงทุนในวันนี้อย่างไร
    5. ปิดท้ายด้วยมุมคิดหรือกำลังใจสำหรับนักลงทุน

    ข้อกำหนด:
    - ใช้ภาษาพูดที่เป็นธรรมชาติ น่าฟัง มีพลัง แต่ไม่เวอร์เกินจริง
    - ลงรายละเอียดมากกว่าปัจจุบัน โดยให้มีเหตุและผล ไม่ใช่แค่ท่องตัวเลข
    - อธิบายตลาดแบบเข้าใจง่าย เหมือนเล่าให้คนฟังตอนขับรถตอนเช้า
    - ห้ามใช้ Bullet Point ห้ามใช้ดอกจัน ห้ามใช้แฮชแท็ก และห้ามใส่หัวข้อย่อย
    - ให้อ่านตัวเลขแบบกลมๆ ฟังง่าย ลดทศนิยมที่ไม่จำเป็น
    - ความยาวควรพอให้ได้เนื้อหาประมาณ 3 ย่อหน้าขึ้นไป และอย่างน้อย 10 ประโยคเต็ม
    - ห้ามเขียนเป็นภาษาทางการแข็งๆ หรือเหมือนรายงานตลาด
    """
