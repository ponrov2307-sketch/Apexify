...
def admin_toggle_maintenance():
    ...
    # 🌟 Broadcast ใน background — ใช้ helper เดียวกับ /maintenance ในบอท
    from bot_utils import broadcast_maintenance_notice
    broadcast_maintenance_notice(_get_bot(), enabled, admin_id=ADMIN_ID)
